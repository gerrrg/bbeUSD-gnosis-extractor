...
## Unpause pools and send etokens to contract
for token in input_tokens:
    txs.append(token.unpause({'from':MULTISIG}))
for etoken in etokens:
    transfer_internal_all(etoken,MULTISIG,helper)
## Set dust factors to handle smol amounts that can not be traded.
dustfactors = [350,300]
## Run the arb contract
